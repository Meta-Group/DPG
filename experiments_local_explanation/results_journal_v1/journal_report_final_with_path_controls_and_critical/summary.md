...
| method              | graph_construction_mode | datasets | total_samples | mean_critical_node_present_rate | mean_critical_eligible_rate | mean_critical_comp_label_changed_rate | mean_critical_changed_to_competitor_rate | mean_control_same_depth_changed_to_competitor_rate | mean_control_random_path_changed_to_competitor_rate | mean_critical_comp_competitor_delta | mean_critical_vs_same_depth_competitor_delta | mean_critical_vs_random_path_competitor_delta |
| ------------------- | ----------------------- | -------- | ------------- | ------------------------------- | --------------------------- | ------------------------------------- | ---------------------------------------- | -------------------------------------------------- | --------------------------------------------------- | ----------------------------------- | -------------------------------------------- | --------------------------------------------- |
| dpg                 | aggregated_transitions  | 15       | 6079          | 0.1962                          | 0.06014                     | 0.0263                                | 0.02463                                  | 0.01675                                            | 0.04779                                             | -0.001469                           | -0.002437                                    | -0.01674                                      |
| dpg_execution_trace | execution_trace         | 15       | 6079          | 0                               | 0                           |                                       |                                          |                                                    |                                                     |                                     |                                              |                                               |

Interpretation:

- Aggregated DPG exposes critical nodes in 19.6% of held-out cases on average, but only 6.0% are intervention-eligible under the current non-root successor test.
- The changed-to-competitor rate is 2.5%, compared with 4.8% for the random-path control; this is weak evidence for a causal intervention claim.
- Execution-trace DPG has no critical nodes under this definition, because the trace variant does not create the same recombined divergence structure.
- Paper framing: report critical nodes as a conditional descriptive diagnostic, while using confidence, support margin, and competitor exposure as the main diagnostic-value evidence.
